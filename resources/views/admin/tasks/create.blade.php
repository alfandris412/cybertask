<x-app-layout>
    <x-slot name="header">
        <div class="flex justify-between items-center">
            ...
            <a href="{{ route('tasks.index') }}" class="text-slate-400 hover:text-white transition-colors text-sm">
                &larr; Kembali
            </a>
        </div>
    </x-slot>
                ...
                <div class="p-8 text-slate-300 relative z-10" 
                     x-data="{
                        ...
                        async fetchMembers() {
                            ...
                            try {
                                let response = await fetch(`/admin/projects/${this.projectId}/members`);
                    ...
                    <form action="{{ route('tasks.store') }}" method="POST">
                        ...
                        <div class="mb-6">
                            ...
                            <select name="project_id" x-model="projectId" @change="fetchMembers()" class="w-full rounded-2xl border-slate-700 bg-slate-950/50 text-white shadow-inner focus:border-indigo-500 focus:ring-indigo-500 focus:ring-2 focus:bg-slate-900 transition-all duration-300 p-3 cursor-pointer" required>
